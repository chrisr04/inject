...
/// A type definition for a function that asynchronously creates a service of type [T] with specific params.
typedef FutureParamServiceCreator<T> = Future<T> Function(Map<String, dynamic>);

/// A type definition for a function that asynchronously creates a service of type [T].
typedef FutureServiceCreator<T> = Future<T> Function();
